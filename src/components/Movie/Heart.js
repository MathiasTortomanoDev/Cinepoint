    ...
    return (
        <div>
            <div className="movie__favorite">
                <svg className="movie__favorite__icon__container" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <path className="movie__favorite__icon" d={favorite 
